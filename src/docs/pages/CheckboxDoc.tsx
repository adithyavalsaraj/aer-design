  ...
  const overview = (
    <div className="space-y-12">
      ...
      >
        <UsageGuidelines
          do={[
            "Selecting a single item from a small set (< 5 options)",
            "Comparing mutually exclusive options side-by-side",
            "Presenting rich tiered options using the card variant",
            "Clear binary choices where both options should be visible",
          ]}
          dont={[
            "Selecting multiple items (use Checkbox instead)",
            "Large lists of items (> 5-7 options, use Dropdown instead)",
            "Setting-like toggles that provide immediate feedback (use Switch instead)",
          ]}
        />
      </DocSection>

      <DocSection title="Basic Usage" id="basic">
        <div className="flex items-center justify-center p-6 border rounded-lg bg-aer-muted/5">
          <Checkbox
      ...
      <DocSection title="States" id="states">
        <div className="flex flex-col gap-4 items-center justify-center p-6 border rounded-lg bg-aer-muted/5">
      ...
      <DocSection title="Sizes" id="sizes">
        <div className="flex items-end gap-x-8 justify-center p-6 border rounded-lg bg-aer-muted/5">
